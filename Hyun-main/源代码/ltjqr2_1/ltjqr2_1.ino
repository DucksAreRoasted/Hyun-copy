...
{    
  ...
  if (sBus.toChannels == 1)
  {
    ...
    sbuschx[0] =  map(sBus.channels[0], 440, 1560, 4400, -4400);
    sbuschx[1] =  map(sBus.channels[1], 440, 1560, 33, -33);
    sbuschx[2] =  map(sBus.channels[3], 440, 1560, 0, 800);
    sbuschx[3] =  map(sBus.channels[2], 200, 1800, -40, 40);
    sbuschx[4] =  map(sBus.channels[5], 192, 1792, 0, 2);
    sbuschx[5] =  map(sBus.channels[4], 192, 1792, 0, 2);
...
int Mpu6050Int()
{
  ...
  mpu.setYAccelOffset(843);
  mpu.setZAccelOffset(866);
